...
import 'package:tasko_mobile/ui/feature/agenda_visita/manter/agenda_visita_manter_controllers.dart';
import 'package:tasko_mobile/ui/feature/agenda_visita/manter/agenda_visita_manter_ui_state.dart';
import 'package:tasko_mobile/ui/feature/agenda_visita/manter/agenda_visita_manter_view_model.dart';
import 'package:tasko_mobile/util/result.dart';

class AgendaVisitaManterScreen extends BaseScreen {
  final int id;

  const AgendaVisitaManterScreen({super.key, required this.id});

  @override
  BaseScreenState<AgendaVisitaManterScreen> createState() =>
      _AgendaVisitaManterScreenState();
}

class _AgendaVisitaManterScreenState
    extends BaseScreenState<AgendaVisitaManterScreen> {
  late final AgendaVisitaManterControllers _controllers;
  int? _hydratedVisitaId;

  @override
  void initState() {
    super.initState();

    _controllers = AgendaVisitaManterControllers();
    final viewModel = ref.read(agendaVisitaManterViewModelProvider.notifier);
    ...
    ref
        .read(agendaVisitaManterViewModelProvider)
        .obterPorIdCommand
        .execute(widget.id);
  }
  ...
  Widget buildContent(BuildContext context) {
    final viewModel = ref.watch(agendaVisitaManterViewModelProvider);
    final viewState = ref.watch(agendaVisitaManterViewModelProvider);
    final visitaAtual = viewState.visita;
    final visitaId = visitaAtual?.id;

    if (visitaId != null && _hydratedVisitaId != visitaId) {
      _controllers.updateFormFields(visitaAtual);
      _hydratedVisitaId = visitaId;
    }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildLoadingDropdownFieldVendedor(
                      ref.watch(agendaVisitaManterViewModelProvider),
                    ),
                  ],
                ),
              ),
  ...
  Widget _buildLoadingDropdownFieldVendedor(
    AgendaVisitaManterUiState viewModel,
  ) {
    final notifier = ref.read(agendaVisitaManterViewModelProvider.notifier);
  ...
  Widget buildDropdownFieldVendedor(AgendaVisitaManterUiState viewModel) {
    final notifier = ref.read(agendaVisitaManterViewModelProvider.notifier);
  ...
  // -- Cliente Dropdown
  Widget _buildLoadingDropdownFieldCliente(
    AgendaVisitaManterUiState viewModel,
  ) {
    final notifier = ref.read(agendaVisitaManterViewModelProvider.notifier);
  ...
  Widget buildDropdownFieldCliente(AgendaVisitaManterUiState viewModel) {
    final notifier = ref.read(agendaVisitaManterViewModelProvider.notifier);
  ...
  // -- Status Dropdown
  Widget _buildLoadingDropdownFieldStatus(AgendaVisitaManterUiState viewModel) {
    final notifier = ref.read(agendaVisitaManterViewModelProvider.notifier);
  ...
  Widget buildDropdownFieldStatus(AgendaVisitaManterUiState viewModel) {
    final notifier = ref.read(agendaVisitaManterViewModelProvider.notifier);
