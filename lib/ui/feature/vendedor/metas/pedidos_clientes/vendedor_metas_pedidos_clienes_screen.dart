      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: Text("Meta", style: kTestStyleMediumText14)),
              Text("120", style: kTestStyleBoldText18),
            ],
          ),
          SizedBox(height: 1),
          Row(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text("85", style: kTestStyleBoldText14),
            ],
          ),
          SizedBox(height: 10),
          Row(
            children: [
              ...
              Text("10", style: kTestStyleBoldText14),
            ],
          ),
          SizedBox(height: 10),
          Row(
            children: [
              ...
              Text("18", style: kTestStyleBoldText14),
            ],
          ),
          SizedBox(height: 10),
        ],
