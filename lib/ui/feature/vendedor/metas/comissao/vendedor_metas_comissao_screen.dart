...
class VendedorMetasComissaoScreen extends BaseScreen {
  final Function(String value) onPrevious;
  final Function(String value) onNext;

  const VendedorMetasComissaoScreen({
    super.key,
  ...
  @override
  BaseScreenState<VendedorMetasComissaoScreen> createState() =>
      _VendedorMetasComissaoScreenState();
}

class _VendedorMetasComissaoScreenState
    extends BaseScreenState<VendedorMetasComissaoScreen> {
  @override
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 15),
                                  _buildResumoComissao(),
                                  SizedBox(height: 15),
                                  _buildPrevisaoComissao(),
                                ],
                              ),
                            ],
                          ),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text("5%", style: kTestStyleBoldText14),
            ],
          ),
          SizedBox(height: 10),
          Row(
            children: [
              ...
              Text("R\$ 32.500,00", style: kTestStyleBoldText14),
            ],
          ),
          SizedBox(height: 15),
          Row(
            children: [
              ...
              Text("R\$ 4.120,00", style: kTestStyleBoldText14),
            ],
          ),
          SizedBox(height: 15),
          Row(
            children: [
              Expanded(
                child: Text(
                  "Comissão do mesmo mês do ano anterior",
                  style: kTestStyleRegularText14,
                ),
              ),
              Text("R\$ 3.200,00", style: kTestStyleBoldText14),
            ],
          ),
          SizedBox(height: 10),
        ],
