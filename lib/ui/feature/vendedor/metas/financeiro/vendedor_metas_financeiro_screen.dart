...
class VendedorMetasFinanceiroScreen extends BaseScreen {
  final Function(String value) onPrevious;
  final Function(String value) onNext;

  const VendedorMetasFinanceiroScreen({
    super.key,
  ...
  @override
  BaseScreenState<VendedorMetasFinanceiroScreen> createState() =>
      _VendedorMetasFinanceiroScreenState();
}

class _VendedorMetasFinanceiroScreenState
    extends BaseScreenState<VendedorMetasFinanceiroScreen> {
  @override
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: Text("Mês anterior", style: kTestStyleRegularText14),
              ),
              Text("R\$ 28.000,00", style: kTestStyleBoldText14),
            ],
          ),
          SizedBox(height: 10),
          Row(
            children: [
              ...
              Text("R\$ 24.000,00", style: kTestStyleBoldText14),
            ],
          ),
          SizedBox(height: 10),
        ],
                  ...
                  bottomTitles: AxisTitles(
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, meta) {
                        ...
                        if ([1, 5, 8, 11, 15, 22, 29].contains(day)) {
                          return Text(
