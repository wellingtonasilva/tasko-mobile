...
class SubgrupoManterControllers {
  final formKey = GlobalKey<FormState>();
  late final CustomFormFieldData descricaoSubgrupo;

  SubgrupoManterControllers() {
  ...
  void updateFormFields(ProdutoSubgrupoResponse subgrupoAtual) {
    descricaoSubgrupo.controller.text = subgrupoAtual.descricaoSubgrupo ?? '';
  }
}
