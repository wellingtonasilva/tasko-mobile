...
class CriarContaScreen extends BaseScreen {
  const CriarContaScreen({super.key});

  @override
  BaseScreenState<CriarContaScreen> createState() => _CriarContaScreenState();
}

class _CriarContaScreenState extends BaseScreenState<CriarContaScreen> {
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Text(
                                      ...
                                      style: kTestStyleBoldText14.copyWith(
                                        color:
                                            kColorStyleInformationDarkDefault,
                                      ),
                                    ),
                                  ),
                                ],
