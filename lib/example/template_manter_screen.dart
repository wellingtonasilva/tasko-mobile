...
class TemplateManterScreen extends BaseScreen {
  const TemplateManterScreen({super.key});

  @override
  BaseScreenState<TemplateManterScreen> createState() =>
      _TemplateManterScreenState();
}

class _TemplateManterScreenState extends BaseScreenState<TemplateManterScreen> {
  @override
